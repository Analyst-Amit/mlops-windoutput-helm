...
def setup_mlflow_tracking(uri=os.getenv("MLFLOW_TRACKING_URI")):
    """
...
def prepare_evaluation_data():
    ...
    data = pd.DataFrame(
        {
            "wind_speed": [8.218296051, 4.995032787, 2.212670088, 2.190548897, 4.157712936],
            "theoretical_power": [1657.373187, 334.7802577, 0, 0, 152.8500671],
            "wind_direction": [78.12586975, 17.07011986, 127.6598969, 329.9155884, 81.20819855],
            "month": [8.0, 5.0, 4.0, 7.0, 4.0],
            "hour": [21.0, 11.0, 19.0, 11.0, 10.0],
        }
    )
