...
from pipelines.pre_process import preprocess_input
from sklearn.ensemble import ExtraTreesRegressor
from utils._config import get_argv_config, load_env_file, parse_args
...
def main(config) -> None:
    ...
    with mlflow.start_run(run_name=mlflow_config["model_run_name"]):
        ...
        payload = {"inputs": dataDF.to_dict(orient="records")}
        X_train, y_train, X_test, y_test = preprocess_input(payload)
